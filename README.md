...
## 설치
```
git clone https://github.com/Jihyun3478/logi-lang.git
```
...
- Blog
  - [[밑바닥부터 만드는 인터프리터 with go] 1. 렉서 동작 원리](https://jihyun-devstory.tistory.com/82)
  - [[밑바닥부터 만드는 인터프리터 with go] 2. 파서 동작 원리](https://jihyun-devstory.tistory.com/83)
  - [[밑바닥부터 만드는 인터프리터 with go] 3. 평가기 동작 원리](https://jihyun-devstory.tistory.com/89)
